 ...
 *
 * This works out-of-the-box if you use the Docker Compose configuration at
 ...
 */
@EnableBinding(value = { MessageBinderConfiguration.class/* ,Source.class */ })
...
//		return () -> new GenericMessage<>("Test message from " + applicationName + " sent at "
